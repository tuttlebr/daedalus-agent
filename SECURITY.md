...
- The username selected by `ADMIN_USERNAME` is trusted with the frontend's
  user-management endpoint (`/api/auth/users`: list, create, and password
  reset). No other cross-user administrative surface is exposed.
