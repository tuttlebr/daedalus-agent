...
const BUILD_PRECACHE = [
  '/_next/static/chunks/webpack-d9fbef5071f28353.js',
  '/_next/static/chunks/framework-5efcc278ab65c75a.js',
  '/_next/static/chunks/main-392452de8e115c0a.js',
  '/_next/static/css/8a6cb53c28b5cde4.css',
  '/_next/static/chunks/9900-42c283230d477192.js',
  '/_next/static/css/8d63a046060bb8d1.css',
  '/_next/static/chunks/pages/_app-a9dd5f88cf39a512.js',
  '/_next/static/chunks/6932-15a7cdb67c3c63b0.js',
  '/_next/static/chunks/pages/index-09502186bab33a87.js',
  '/_next/static/chunks/pages/login-e99afa9db23baa85.js',
];
...
self.addEventListener('fetch', (event) => {
  ...
  if (url.pathname.startsWith('/api/')) {
    ...
    if (isCacheableApi) {
      event.respondWith(handleConversationApiRequest(request, url));
      return;
    }
    ...
    for (const item of items) {
      try {
        ...
        if (response.ok) {
          ...
          swLog.warn(
            `Failed to send offline message ${item.id}: ${response.status}`,
          );
        }
      } catch (err) {
...
async function handleConversationApiRequest(request, url) {
  ...
  try {
    ...
    swLog.debug(
      `Network failed for ${cacheKey}, trying cache: ${error.message}`,
    );
...
async function invalidateConversationCache(conversationId) {
  try {
    ...
    for (const key of keys) {
      ...
      if (
        url.pathname.includes(conversationId) ||
        url.pathname.endsWith('/conversationHistory')
      ) {
