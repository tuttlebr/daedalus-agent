...
export const StepDetails: React.FC<StepDetailsProps> = ({ step, onClose }) => {
  ...
  const renderJSON = (data: any, title: string) => {
    ...
    return (
      <div className="mb-4">
        ...
        <pre className="bg-gradient-to-br from-slate-100 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 p-3 rounded-lg text-xs overflow-x-auto border border-gray-200 dark:border-gray-700/70 shadow-inner">
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gradient-to-b from-white via-gray-50 to-white dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        {/* Basic Information */}
        <div className="rounded-xl border border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-slate-900/50 p-4 shadow-sm">
