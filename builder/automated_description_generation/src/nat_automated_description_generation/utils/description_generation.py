...
async def generate_description(
    collection_name: str, top_k, field_name, vectorstore, workflow
) -> str:
    try:
        logger.debug("Getting Sample Chunks")
        schema = vectorstore.client.describe_collection(
        ...
        graph.add_conditional_edges(
            ...
            {
                "create_direct_summary": "create_direct_summary",
                "map_batch_summaries": "map_batch_summaries",
            },
        )
