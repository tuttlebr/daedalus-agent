...
MILVUS_AUTH_SOURCE_NAMESPACE="${MILVUS_AUTH_SOURCE_NAMESPACE:-daedalus}"
...
MINIO_AUTH_SOURCE_NAMESPACE="${MINIO_AUTH_SOURCE_NAMESPACE:-daedalus}"
...
PY
  ...
  BACKEND_SECRET_KEYS=(
    ...
    NV_INGEST_HOST NV_INGEST_PORT TOKENIZER
    DOCUMENT_INGEST_REQUEST_LIMIT DOCUMENT_INGEST_CHUNK_SIZE
    DOCUMENT_INGEST_CHUNK_OVERLAP DOCUMENT_INGEST_DEFAULT_COLLECTION
    DOCUMENT_INGEST_EXTRACT_METHOD DOCUMENT_INGEST_USE_V2_API
    DOCUMENT_INGEST_PDF_PAGES_PER_CHUNK DOCUMENT_INGEST_ENABLE_IMAGE_FILTER
    DOCUMENT_INGEST_ENABLE_CAPTIONING DOCUMENT_INGEST_WORKER_POOL_SIZE
    DOCUMENT_INGEST_BATCH_CONCURRENCY DOCUMENT_INGEST_MAX_DOCUMENTS_PER_BATCH
    DOCUMENT_INGEST_MAX_SIZE_BYTES DOCUMENT_INGEST_REDIS_SOCKET_TIMEOUT
    DOCUMENT_INGEST_REDIS_CONNECT_TIMEOUT DOCUMENT_INGEST_TIMEOUT_SECONDS
    DOCUMENT_INGEST_MAX_RETRIES DOCUMENT_INGEST_RETRY_DELAY
    ...
    HINDSIGHT_API_KEY HINDSIGHT_API_TIMEOUT_SECONDS DAEDALUS_MEMORY_READINESS_MODE
    DAEDALUS_MEMORY_CONTEXT_TIMEOUT_SECONDS
  ...
  FRONTEND_SECRET_KEYS=(
    ...
    DOCUMENT_UPLOAD_MAX_CONCURRENT_PER_USER RATE_LIMIT_*
    NEXT_PUBLIC_* DEFAULT_MODEL
  ...
  STREAM_WORKER_SECRET_KEYS=(
    ...
    DOCUMENT_INGEST_TIMEOUT_MS NAT_SUBMIT_MAX_RETRIES NAT_RETRY_DELAY_MS
    NAT_CONNECTIVITY_TIMEOUT_MS
    STREAM_READ_IDLE_TIMEOUT_MS MCP_OAUTH_STREAM_IDLE_TIMEOUT_MS
    DAEDALUS_DEBUG_REPLAY NEXT_PUBLIC_VAPID_PUBLIC_KEY
