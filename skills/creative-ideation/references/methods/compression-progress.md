...
Jürgen Schmidhuber, _Formal Theory of Creativity_ (1990–2010). Beauty = compressibility given prior knowledge. Interestingness = the _change_ in compressibility as you learn. A worthwhile project is one that, on completion, would compress your model of the world.
...
1. List 5–10 things you currently _cannot predict well_ in your domain. Be specific: not "the future of AI", but "why X 7B model trained with technique A performs worse than Y 1.3B model with technique B on benchmark Z".
