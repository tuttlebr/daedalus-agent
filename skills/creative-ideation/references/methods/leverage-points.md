...
**9. Lengths of delays** — relative to rate of system change. Delays usually can't be shortened; the leverage is in _slowing the system to match the delays_.
...
**7. Gain around positive feedback loops** — _Reducing_ gain on a positive loop is more leveraged than strengthening the negative loop counter-acting it. Progressive tax weakens "success-to-the-successful" loops directly.
...
**5. Rules** — incentives, punishments, constraints. Constitutions, laws, terms of service. _"If you want to understand the deepest malfunctions of systems, pay attention to the rules, and to who has power over them."_
...
**3. Goals of the system** — what is it _for_? Shareholder return vs employee welfare = different systems with same physical structure. _"Everything further down the list will be twisted to conform to that goal."_
...
**1. Power to transcend paradigms** — hold any paradigm lightly. The capacity to _switch_. Personal practice, not policy.
...
5. **Note direction risk.** A high-leverage intervention pushed wrong is worse than a low-leverage one pushed right. _"Time after time I've ... discovered that there's already a lot of attention to that point. Everyone is trying very hard to push it IN THE WRONG DIRECTION."_
...
Source: Meadows, _Places to Intervene in a System_ (1997/1999); _Thinking in Systems_ (Chelsea Green, 2008). donellameadows.org.
