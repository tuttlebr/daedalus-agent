...
Improve workflow quality through `nat optimize` after baseline correctness is
established. Success means the evaluator target, trial budget, stopping
behavior, output artifact, and validation step are explicit.
