...
Route NeMo Agent Toolkit work to the narrowest applicable skill and prevent
invented component names or stale configuration patterns. Success means the
focused skill is loaded before implementation and the resulting command or YAML
is validated against registered toolkit components.
