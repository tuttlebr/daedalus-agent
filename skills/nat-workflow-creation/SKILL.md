...
Create, edit, or troubleshoot NeMo Agent Toolkit workflow YAML using registered
components and runnable examples. Success means component `_type` values are
verified, the YAML is scoped to the request, and a minimal `nat run` validation
command is provided or executed.
