...
Create or update AI coding agent skills only when the change will improve
future task behavior. Success means the edited skill is concise, task-oriented,
validated when possible, and does not encode one-off preferences as general
rules.
